	...
	public static void main(String[] args) {
		...
		while (true) {
			try {
				...
				System.out.print("\n请选择使用默认配置，还是自定义配置？1(默认配置) or 0(自定义配置) ");
				if (input.nextInt() == 1) {
					...
					randomFormula = new RandomFormula(numberTotal, formulaTotal, numberRange, maxResult,
							includeMulAndDiv, includeNegNum);
				}
